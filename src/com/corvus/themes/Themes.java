...
public class Themes extends PreferenceFragment implements
    ...
    private void setupNavbarSwitchPref() {
        ...
        if (CorvusUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_rose")){
            mnbSwitch.setValue("6");
        } else if (CorvusUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_blue")){
            mnbSwitch.setValue("5");
        } else if (CorvusUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_purp")){
